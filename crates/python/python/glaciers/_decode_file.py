...
async def async_decode_file(
    ...
    result: pl.DataFrame = await _glaciers_python.decode_file(file_path, abi_df_path, is_log_type)
...
def decode_file(
    ...
    import asyncio
    coroutine = async_decode_file(file_path, decoder_type, abi_df_path)
