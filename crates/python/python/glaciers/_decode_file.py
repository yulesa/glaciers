...
async def async_decode_file(
    ...
    result: pl.DataFrame = await _glaciers_python.decode_file(decoder_type, file_path, abi_df_path)
...
def decode_file(
    ...
    import asyncio
    coroutine = async_decode_file(decoder_type, file_path, abi_df_path)
